component rest="true" restpath="/chemicals" {
    ...
    remote any function createChemical(required string jsonPayload restArgSource="body") httpmethod="POST" restpath="create" {
        systemOutput("createChemical REST Call. With json...");
        systemOutput(jsonPayload);
