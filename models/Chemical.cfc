...
component persistent="true" accessors="true" {
    ...
    property name="casNumber" column="casNumber" ormtype="string" length="255";

    // optional GHS / SDS fields
    // IUPAC systematic name (e.g. "oxidane" for water)
    property name="iupacName" column="iupacName" ormtype="string" length="255";
    // molecular formula in Hill notation (e.g. "H2O", "C6H6")
    property name="molecularFormula" column="molecularFormula" ormtype="string" length="100";
    // physical state at standard conditions: solid | liquid | gas | unknown
    property name="physicalState" column="physicalState" ormtype="string" length="20";
    // molecular weight in g/mol (e.g. "18.015")
    property name="molecularWeight" column="molecularWeight" ormtype="string" length="50";
